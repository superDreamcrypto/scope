...
$id = $_GET['id'];
$deviceArray = getDeviceByID($id);

$deviceUserID = $deviceArray[1];
$phone = $deviceArray[2];
$name = $deviceArray[3];
            ...
            <div class="container ">
              <div class="row main">
                ...
                <div class="main-center" >
                  ...
                  <form class="" method="post" action="../utils/adminEditDeviceUtil.php?id=<?php echo $id;?>">
                    
                  <div class="form-group">
                      <label for="deviceid" class="cols-sm-2 control-label">Device ID </label>
                      <div class="cols-sm-10">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                          <input type="text" class="form-control" name="deviceid" id="deviceid" readonly value="<?php echo $id ; ?>" />
                        </div>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="userdeviceid" class="cols-sm-2 control-label">Device User ID </label>
                      <div class="cols-sm-10">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                          <input type="text" class="form-control" name="userdeviceid" id="userdeviceid" readonly value="<?php echo $deviceUserID ; ?>" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <button type="submit" action="../utils/adminEditDeviceUtil.php?id=<?php echo $id;?>" class="btn btn-primary btn-lg btn-block login-button">Edit Device</button>
                    </div>
                  </div>
