        ...
        <div class="col-sm-8 mx-auto">
          ...
          <div class="container">
            <div class="cols-sm-6 cols-sm-offset-3 text-center">
              <h1 class=""><b>Add New Device</b></h1>
            </div>
          </div>
            ...
            <div class="container ">
              <div class="row main">
                ...
                <div class="main-center" >
                  ...
                  <form class="" method="post" action="../utils/addDeviceUtil.php">

                    <div class="form-group">
                      <label for="deviceName" class="cols-sm-2 control-label">Devive Name</label>
                      <div class="cols-sm-10">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
                          <input type="text" class="form-control" name="deviceName" id="deviceName"  placeholder="Enter a name for your device" required autofocus/>
                        </div>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="phone" class="cols-sm-2 control-label">Device Phone umber</label>
                      <div class="cols-sm-10">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                          <input type="text" class="form-control" name="phone" id="phone"  placeholder="Enter device phone number" required autofocus/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group"> 
                      <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-primary btn-lg btn-block login-button">Add Device</button>
                      </div>
                    </div>
