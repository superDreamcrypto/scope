            ...
            <div class="container ">
              <div class="row main">
                ...
                <div class="main-center" >
                  ...
                  <form class="" method="post" action="../utils/adminEditUserUtil.php?id=<?php echo $id;?>">
                    
                  <div class="form-group">
                      <label for="profname" class="cols-sm-2 control-label">User ID </label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="cols-sm-10">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                          <input type="text" class="form-control" name="profname" id="profname"  value="<?php echo $fName ; ?>" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="cols-sm-10">
                        <div class="input-group">
                          ...
                          <input type="file" class="form-control" name="file" id="file"   value="<?php echo $imageName; ?>" />
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
